...
<html lang="es">
    <head>
        ...
        <meta name="description" content="MusicHub - Comparte tus canciones favoritas">
        <?php
        ...
        ?>
        <title>MusicHub - Comparte tus canciones favoritas</title>
        <!-- Favicon -->
    ...
    <body id="main_page">
        <div id="main_box">
            <header>
                <h1 class="site-title">Music<span class="hub-text">Hub</span></h1>
